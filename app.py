...
def go_to(page: str) -> None:
    ...
    st.session_state["confirm_group_save"] = False
    rerun()
...
def main() -> None:
    ...
    st.session_state.setdefault("confirm_group_save", False)
